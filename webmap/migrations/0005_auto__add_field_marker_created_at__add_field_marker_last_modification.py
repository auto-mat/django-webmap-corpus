...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marker.created_at'
        db.add_column(u'webmap_marker', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Marker.last_modification'
        db.add_column(u'webmap_marker', 'last_modification',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Marker.created_at'
        db.delete_column(u'webmap_marker', 'created_at')

        # Deleting field 'Marker.last_modification'
        db.delete_column(u'webmap_marker', 'last_modification')
