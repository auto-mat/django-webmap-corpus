...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'webmap_photo', 'photographer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Marker.menu_icon'
        db.add_column(u'webmap_marker', 'menu_icon',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'webmap_photo', 'photographer')

        # Deleting field 'Marker.menu_icon'
        db.delete_column(u'webmap_marker', 'menu_icon')
