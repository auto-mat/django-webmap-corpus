...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BaseLayer'
        db.create_table(u'webmap_baselayer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=-1)),
        ))
        db.send_create_signal(u'webmap', ['BaseLayer'])


        # Changing field 'Layer.order'
        db.alter_column(u'webmap_layer', 'order', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Property.order'
        db.alter_column(u'webmap_property', 'order', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Photo.created_at'
        db.add_column(u'webmap_photo', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.last_modification'
        db.add_column(u'webmap_photo', 'last_modification',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Photo.order'
        db.alter_column(u'webmap_photo', 'order', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting model 'BaseLayer'
        db.delete_table(u'webmap_baselayer')


        # Changing field 'Layer.order'
        db.alter_column(u'webmap_layer', 'order', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Property.order'
        db.alter_column(u'webmap_property', 'order', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Deleting field 'Photo.created_at'
        db.delete_column(u'webmap_photo', 'created_at')

        # Deleting field 'Photo.last_modification'
        db.delete_column(u'webmap_photo', 'last_modification')


        # Changing field 'Photo.order'
        db.alter_column(u'webmap_photo', 'order', self.gf('django.db.models.fields.PositiveIntegerField')())
